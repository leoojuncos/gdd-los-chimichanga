--/ Leo (usuario, cliente, vendedor) - YA ESTAN
...
--/ Leo (factura, detalle_factura, tipo_detalle_factura, concepto)
...
--/ Leo (almacen, producto, modelo_producto, marca_producto, subrubro, rubo) - YA ESTAN
...
--/ Pablo (parte de domicilio,localidad y provincia) - YA ESTAN
